...
public class OLDRegion extends Path
{
		...
		private ArrayList<LatLng> originalPoints = new ArrayList<>();
		//Points will be the original points
		private ArrayList<LatLng> regionPoints = new ArrayList<>();

		public OLDRegion(ArrayList<LatLng> list, AreaType type)
		{
				setPoints(list);
		...
		public OLDRegion(ArrayList<LatLng> list, AreaType type, Double transect)
		{
				setPoints(list);
				originalPoints = points;
				regionType = type;
