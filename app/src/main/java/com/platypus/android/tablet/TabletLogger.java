...
/**
 * Created by zeshengxi on 2/16/16.
 */
...
public class TabletLogger {
    private static final String TAG = TeleOpPanel.class.getSimpleName();
     ...
     */
    private static final String DEFAULT_LOG_PREFIX = "platypus-tablet_";
